...
try{
  ...
  r = await jsonFetch(base,'/api/credits/balance'); ok(r.status===200 && r.body.free_credits===2 && r.body.paid_credits>=30 && r.body.total>=32, 'credits balance API works with seeded wallet','api');
